 ...
 (function() {
     ...
     const myQuestions = [{
            question: "1. Moment equilibrium about the radial (R) direction is expressed as?", ///// Write the question inside double quotes
            answers: {
                a: "<img src='images/pr1.png' style='height: 43px' draggable='false'>", ///// Write the option 1 inside double quotes
                b: "<img src='images/pr2.png' style='height: 44px' draggable='false'>", ///// Write the option 2 inside double quotes
        ...
        {
            question: "2. Force equilibrium in the z direction is expressed as?", ///// Write the question inside double quotes
            answers: {
                a: "<img src='images/pr5.png' style='height: 50px' draggable='false'>", ///// Write the option 1 inside double quotes
                b: "<img src='images/pr6.png' style='height: 58px' draggable='false'>", ///// Write the option 2 inside double quotes
                c: "<img src='images/pr7.png' style='height: 50px' draggable='false'>", ///// Write the option 1 inside double quotes
                d: "<img src='images/pr8.png' style='height: 50px' draggable='false'>", ///// Write the option 2 inside double quotes
            },
